  ...
  describe("has generated code highlighting html using shiki with thematic block and ast utility", () => {
          ...
          markdown: {
            async highlighter () {
              ...
              return (
                ...
                let code = highlighter.codeToHtml(rawCode, lang)
    ...
    test("renders correctly", () => {
      expect(nuxtContent).toMatchInlineSnapshot(`
        ...
        <div class=\\"highlighted-using-shiki index.ts\\" data-line=\\"1\\"><pre class=\\"shiki\\" style=\\"background-color:#2e3440ff;\\"><code><span class=\\"line\\"><span style=\\"color:#D8DEE9FF;\\">// @errors: 2322</span></span>
        <span class=\\"line\\"><span style=\\"color:#D8DEE9FF;\\">function sum(a: number, b: number): string {</span></span>
        <span class=\\"line\\"><span style=\\"color:#D8DEE9FF;\\">  return true</span></span>
        <span class=\\"line\\"><span style=\\"color:#D8DEE9FF;\\">}</span></span></code></pre></div>"
      `)
